...
void main() {
    gl_Position = vec4((a_Pos.x + positions[gl_InstanceID].x + cameraPosition.x) * cameraPosition.z, (a_Pos.y + positions[gl_InstanceID].y + cameraPosition.y) * cameraPosition.z * cameraPosition.w, 0, 1.0);
}
